...
public class HomeActivity extends AppCompatActivity implements AuthenticationHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AuthenticationManager.login(self);
            }
        });
    ...
    public void onAuthFinished(AuthenticationResult authenticationResult) {
        if (authenticationResult.isSuccessful()) {
            new HomeActivity.GetMethodDemo().execute("http://127.0.0.1:5000/insert");
            auth.setText("Authorized!");
            //WOOT WOOT!! It worked!
        } else {
            new HomeActivity.GetMethodDemo().execute("http://127.0.0.1:5000/insert");
            auth.setText("Fitbit Authorized!");
            //Uh oh... errors...
        }
    }
