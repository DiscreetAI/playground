...
#FOR USE WHEN TESTING ONLY
CLIENT_SECRETS_FILE = 'youtube_client_secret_1.json'
#TO BE USED IN DATASHARK WEB APP
...
if __name__ == '__main__':
  ...
  parser.add_argument('--start-date', default=one_year_ago,
  ...
  ###TO LOOK FOR THINGS IN DIFF SCOPES WE NEED TO AUTHENTICATE AGAIN - TEST FOR
  ###SURE ON WEB APP
